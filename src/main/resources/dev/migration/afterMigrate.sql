...
VALUES ('Bok Choy', 1, 0, 1, '2020-04-16T14:12:39.000+0000', '2020-04-16T14:12:39.000+0000', true, 8, 1, 'EURO')
on conflict do nothing;
...
INSERT INTO products (name, min_quantity_per_order, max_quantity_per_order, quantity_type, created_at, updated_at,
                      in_stock, price, vendor_id, currency)
VALUES ('Mustard Leaves', 1, 0, 0, '2020-04-16T14:12:39.000+0000', '2020-04-16T14:12:39.000+0000', true, 22, 1, 'EURO')
on conflict do nothing;
...
INSERT INTO products (name, min_quantity_per_order, max_quantity_per_order, quantity_type, created_at, updated_at,
                      in_stock, price, vendor_id, currency)
VALUES ('Product 1', 1, 0, 1, '2020-04-16T14:12:39.000+0000', '2020-04-16T14:12:39.000+0000', true, 56, 2, 'EURO')
on conflict do nothing;

INSERT INTO products (name, min_quantity_per_order, max_quantity_per_order, quantity_type, created_at, updated_at,
                      in_stock, price, vendor_id, currency)
VALUES ('Product 2', 1, 0, 2, '2020-04-16T14:12:39.000+0000', '2020-04-16T14:12:39.000+0000', true, 10, 2, 'EURO')
on conflict do nothing;
